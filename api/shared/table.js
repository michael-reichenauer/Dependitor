...
const tablePrefix = tableNamePrefix()


exports.dataTableName = 'data'

exports.createTable = (tableName) => {
    return tableService().createTable(tablePrefix + tableName)
}


exports.client = (tableName) => {
    return TableClient.fromConnectionString(process.env.AZURE_STORAGE_CONNECTION_STRING,
